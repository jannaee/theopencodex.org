			...
			<form action="form-submit.php?form=joinUsModal" method="post" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="email" name="email" required placeholder="name@example.com" class="input-xlarge">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="checkbox">
								<input type="checkbox" name="design" value="Static (2D)">
								Static (2D)
							</label>
							<label class="checkbox">
								<input type="checkbox" name="design" value="Static (3D)">
								Static (3D)
							</label>
							<label class="checkbox">
								<input type="checkbox" name="design" value="Animation (2D)">
								Animation (2D)
							</label>
							<label class="checkbox">
								<input type="checkbox" name="design" value="Animation (3D)">
								Animation (3D)
							</label>
							<label class="checkbox">
								<input type="checkbox" name="design" value="Logo design">
								Logo design
							</label>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<label class="checkbox">
								<input type="checkbox" name="development" value="HTML">
								HTML
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="CSS">
								CSS
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="Javascript">
								Javascript
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="jQuery">
								jQuery
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="Java">
								Java
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="C++">
								C++
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="C#">
							...
							<label class="checkbox">
								<input type="checkbox" name="development" value="PHP">
								PHP
							</label>
							<label class="checkbox">
								<input type="checkbox" name="development" value="Scala">
								Scala
							</label>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-prepend">
								...
								<input class="input-xlarge" name="github_handle" id="prependedInput" type="text" placeholder="Username">
							</div>
